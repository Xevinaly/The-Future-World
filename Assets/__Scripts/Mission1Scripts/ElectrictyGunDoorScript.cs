...
public class ElectrictyGunDoorScript : MonoBehaviour {
	...
	void Start () {
		GameObject.Find("StandardRobot (10)").GetComponent<Enemy>().EnemyHealth = 1000000;
		GameObject.Find("StandardRobot (11)").GetComponent<Enemy>().EnemyHealth = 1000000;
		GameObject.Find("StandardRobot (12)").GetComponent<Enemy>().EnemyHealth = 1000000;
